# Rufus Edge Dashboard

A production-grade React/Next.js 14 management UI for the Rufus Edge control plane.
...
| `NEXT_PUBLIC_RUFUS_API_URL` | Yes | Rufus API URL (e.g. `http://localhost:8000`) |
