...
Once the Ruvon Server is running, the Debug UI is available at:
...
The Debug UI is a **pure frontend application** that communicates with Ruvon Server APIs:
...
- **Date**: 2026-02-13
- **License**: Same as Ruvon SDK

## Related Documentation

- [CLAUDE.md](../../CLAUDE.md) - Main Ruvon SDK documentation
- [USAGE_GUIDE.md](../../USAGE_GUIDE.md) - Workflow usage examples
- [CONFUCIUS_VS_RUVON_ANALYSIS.md](../../CONFUCIUS_VS_RUVON_ANALYSIS.md) - Feature comparison
