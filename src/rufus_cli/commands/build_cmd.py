"""
rufus build — AI-assisted workflow builder.
...
def generate(
    ...
    Examples:
        ...
        rufus build generate "handle incoming bid submissions for Neelo UAE"

        rufus build generate "handle bids" --backend ollama --model llama3

        rufus build generate "handle bids" --dry-run --out bid-intake.yaml

        rufus build generate --from-file existing.yaml "add anomaly detection"
    """
    asyncio.run(
        _run_single_shot(
            prompt=prompt,
...
def interactive_session(
    ...
    Example:
        ...
        rufus build interactive --backend ollama --model llama3
    """
...
def explain_workflow(
    ...
    Example:
        ...
        rufus build explain config/payment_workflow.yaml
    """
