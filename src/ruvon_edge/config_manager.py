...
class ConfigManager:
    ...
    async def initialize(self):
        ...
        if self._adapter is None:
            from ruvon_edge.platform import detect_platform
    ...
    async def _get_hardware_identity(self) -> Dict[str, Any]:
        ...
        """
        try:
            from ruvon.implementations.inference.factory import InferenceFactory
        ...
        try:
            from ruvon.utils.platform import get_platform_info
