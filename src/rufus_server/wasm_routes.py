...
async def upload_wasm_component(
    ...
    from rufus_server.main import persistence_provider, require_admin
    from rufus_server.auth import get_current_user
...
async def download_wasm_component(
    ...
    """
    from rufus_server.main import persistence_provider
