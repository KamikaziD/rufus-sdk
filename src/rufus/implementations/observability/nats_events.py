...
Activated by passing NATSEventObserver as workflow_observer:
    ...
    from rufus.implementations.observability.nats_events import NATSEventObserver
...
class NATSEventObserver(WorkflowObserver):
    ...
    async def _publish(self, event_type: str, workflow_id: str, workflow_type: str,
        ...
        try:
            ...
            if _USING_PROTO:
                try:
                    from rufus.proto.gen import WorkflowEvent
                    msg = WorkflowEvent(
                        event_type=event_type,
                        workflow_id=workflow_id,
                        workflow_type=workflow_type,
    ...
    async def on_workflow_started(self, workflow_id: str, workflow_type: str, initial_state: Any):
        await self._publish(
            ...
            stream_key="rufus:workflow_lifecycle",
        )
    ...
    async def on_step_executed(
        ...
        await self._publish(
            ...
            payload, stream_key="rufus:step_events",
        )
    ...
    async def on_workflow_status_changed(
        ...
        await self._publish(
            ...
            stream_key="rufus:workflow_status_changes",
        )
    ...
    async def on_compensation_completed(
        ...
        await self._publish(
            ...
            payload, stream_key="rufus:saga_events",
        )
