...
Activated by passing NATSExecutionProvider to WorkflowBuilder.create_workflow():
    ...
    from rufus.implementations.execution.nats_executor import NATSExecutionProvider
...
from rufus.providers.execution import ExecutionProvider, ExecutionContext
...
class NATSExecutionProvider(ExecutionProvider):
    ...
    async def dispatch_async_task(
        ...
        **kwargs,
        ...
        try:
            ...
            if _USING_PROTO:
                try:
                    from rufus.proto.gen import TaskDispatch
                    msg = TaskDispatch(
    ...
    async def dispatch_parallel_tasks(
        ...
        for i, task_cfg in enumerate(tasks):
            ...
            reply_subject = f"_INBOX.rufus.{task_id}"
