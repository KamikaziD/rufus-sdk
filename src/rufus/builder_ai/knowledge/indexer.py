...
class KnowledgeBase:
    ...
    DEFAULT_DB_PATH = Path.home() / ".rufus" / "knowledge.lance"
    DEFAULT_MANIFEST_PATH = Path.home() / ".rufus" / "index_manifest.json"
    ...
    def build(
        ...
        Args:
            ...
            db_path:      Override default DB path (~/.rufus/knowledge.lance).
