...
for NATS wire transport. Enabled when RUVON_USE_PROTO=true (default) and
...
_ORJSON_ENABLED = os.getenv("RUVON_USE_ORJSON", "true").lower() == "true"
...
_MSGSPEC_ENABLED = os.getenv("RUVON_USE_MSGSPEC", "true").lower() == "true"
...
# ---------------------------------------------------------------------------
# Proto codec (betterproto, optional — gated by RUVON_USE_PROTO)
# ---------------------------------------------------------------------------

_PROTO_ENABLED = os.getenv("RUVON_USE_PROTO", "true").lower() == "true"
_USING_PROTO = False
if _PROTO_ENABLED:
    try:
