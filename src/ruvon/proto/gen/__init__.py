...
the RUVON_PROTO_BACKEND environment variable (default: "betterproto").

Set RUVON_PROTO_BACKEND=google to use the google.protobuf C-extension
...
lazy `try: from ruvon.proto.gen import X` will handle ImportError.
"""

import os

_BACKEND = os.getenv("RUVON_PROTO_BACKEND", "betterproto")
