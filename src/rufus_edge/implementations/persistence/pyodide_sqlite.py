...
This provider is instantiated automatically by ``browser_loader.js``::
    ...
    from rufus_edge.implementations.persistence.pyodide_sqlite import (
        PyodideSQLiteProvider,
    )
    persistence = PyodideSQLiteProvider(db_name="rufus_edge")
...
class PyodideSQLiteProvider:
    ...
    Args:
        db_name: The OPFS database name (default: ``"rufus_edge"``).
    """

    def __init__(self, db_name: str = "rufus_edge"):
    ...
    async def _create_schema(self):
        ...
        from rufus.implementations.persistence.sqlite import SQLITE_SCHEMA  # type: ignore
    ...
    def __getattr__(self, name: str):
        ...
        """
        from rufus.implementations.persistence.sqlite import SQLitePersistenceProvider  # type: ignore
