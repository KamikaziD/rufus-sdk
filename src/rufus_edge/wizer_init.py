"""
Wizer pre-initialization hook for rufus-sdk-edge WASM builds.

This module is invoked once at compile time by the Wizer snapshotting tool:

    wizer --init-func=rufus_pre_init -o dist/rufus_edge_snapshotted.wasm dist/rufus_edge.wasm
...
def rufus_pre_init() -> None:
    ...
    from rufus.models import WorkflowStep  # noqa: F401
    from rufus.builder import WorkflowBuilder  # noqa: F401

    # Edge agent — the main entry point class
    from rufus_edge.agent import RufusEdgeAgent  # noqa: F401
