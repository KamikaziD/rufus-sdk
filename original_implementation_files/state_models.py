...
class CollectApplicationDataInput(WorkflowInput):
    user_id: str
    name: str
    email: str
    country: str
...
class CreateUserProfileInput(WorkflowInput):
    name: str
    email: str

class ComplianceReviewFetchClientDataInput(WorkflowInput):
    client_id: str

class ImageComplianceCollectComplianceAssetsInput(WorkflowInput):
    image_url: Optional[str] = None
    compliance_text: Optional[str] = None

class ProcessHumanDecisionInput(WorkflowInput):
    decision: str
    reviewer_id: str
