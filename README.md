...
| **Approvals** | Operator+ | `HUMAN_IN_LOOP` approval queue; approve or reject with notes; domain-specific panels (FraudReviewPanel, LoanReviewPanel) for contextual HITL decisions |
